# Arduino on Linux (Arch)

- to check if device is connected run `ls /dev` and look for `ttyAM0`

## Teensy Setup

1. Follow [guide](https://www.pjrc.com/teensy/td_download.html) to get Arduino IDE addon
2. create a file under `/etc/udev/rules.d/00-teensy.rules` with the code:
